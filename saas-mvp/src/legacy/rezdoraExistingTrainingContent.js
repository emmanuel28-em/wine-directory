// Existing restaurant training content migrated from the original static app.
// This file is source material for the reusable import utility; it is not demo-only data.
export const rezdoraExistingTrainingContent = [
  {
  ...
  },
  {
    ...
    "menu": "Dinner",
    "course": "Antipasta",
    "menuDescription": "Toasted bread with extra virgin olive oil",
  ...
  },
  {
    ...
    "menu": "Brunch",
    "course": "Antipasta",
    "menuDescription": "Fennel, nectarines, thyme, and pine nuts",
    "pronunciation": "",
    "mise": "Small Fork, Butter Knife",
    "winePairings": [],
    "allergies": [
  ...
  },
  {
    ...
    "menu": "Lunch",
    "course": "Antipasta",
    "menuDescription": "Stracciatella, mortadella, and pistachio",
    "pronunciation": "",
    "mise": "Small Fork, Butter Knife",
    "winePairings": [],
    "allergies": [
    ...
    "oneLiner": "Toasted fett'unta topped with stracciatella, mortadella, pistachio nut and paste with olive oil.",
    "details": "Our fett'unta has stracciatella on the base with sliced mortadella, pistachio paste from Sicilia, and toasted pistachios on top."
  },
  {
    "type": "food",
    "name": "Insalata di Finocchio",
  ...
  },
  {
    ...
    "oneLiner": "Our affettati misti that can be enjoyed with our tigelle, a traditional bread from Emilia-Romagna.",
    "details": "The plate includes four pieces of each meat assortment and 24 month aged parmigiano with two tigelles, a traditional bread from Emilia-Romagna. Tigelles are typically made with lardo, but we use butter instead."
  },
  {
    "type": "food",
    "name": "Cachi Affumicata",
    "status": "previous",
    "category": "Antipasta",
    "menu": "Lunch",
    "course": "Antipasta",
    "menuDescription": "Smoked stracciatella, persimmons, Saba, and thyme",
    "pronunciation": "",
    "mise": "Small Fork, Butter Knife",
    "winePairings": [],
    "allergies": [
    ...
    "oneLiner": "Our Cachi affumicata, with persimmons, smoked stracciatella, saba, and thyme.",
    "details": "Persimmons are cut into small cubes and tossed with saba, EVOO, and salt, then plated in a ring mold. Persimmon puree, made with persimmon, thyme, and salt, is put on top, followed by smoked stracciatella. Thinly sliced persimmons are pickled and placed on top, then the dish is finished with persimmon powder and thyme powder."
  },
  {
    "type": "food",
