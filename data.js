...
window.wineDirectoryData = [
  ...
  },
  {
    ...
    "oneLiner": "The benchmark bottling for Freisa, a rare indigenous Piemontese grape closely related to Nebbiolo. Expect dark fruits, violets, black pepper, and a hint of smoke, with a profile akin to Northern Rhone Syrah.",
    "details": "G.D. Vajra is passionately committed to the resuscitation of Freisa, a rare grape indigenous to Piemonte. The Kye bottling, from vineyards in the commune of Barolo, is widely hailed as the benchmark expression of the variety. Darker-fruited and more rustic than Nebbiolo, Freisa shows dark purple in the glass and offers notes of dark berries, wild herbs, black pepper, and a hint of meatiness. The wine spends 12 to 18 months in Slavonian oak and barriques, depending on the vintage, adding weight and power and making it a good option for guests looking for something akin to Cabernet or Syrah. The name Kye is derived from a local Piemontese expression that translates as 'who is it?'",
    "pairing": "Ideal for heartier fare such as meat-based pastas, Cow Grazing, and Costata."
  },
  {
  ...
  },
  {
    ...
    "oneLiner": "Among the most outstanding Langhe Rosso wines in existence, from an iconic producer of Barbaresco and Barolo. Sourced from young Nebbiolo vines in Roagna's Pira and Paje vineyards, this is fresh, herbal, smoky, spicy, earthy, and sophisticated.",
    "details": "Roagna is an icon. Their wines are pure, organically farmed examples from some of the finest vineyards in Barolo and Barbaresco, farmed and vinified traditionally. They are among the most noble and precise expressions of these areas, blending uncommon elegance and accessibility in regions that can often be challenging.",
    "pairing": "A strong match for refined meat dishes, truffle-leaning flavors, mushroom preparations, and pastas that benefit from Nebbiolo's spice, earth, and structure."
  },
  {
  ...
  },
  {
    ...
    "oneLiner": "A dry Lambrusco produced in Metodo Classico, also known as the Champagne Method, instead of the tank or Charmat method typically used for Lambrusco. An exclusive U.S. pour at Rezdora, with dry but full-fruited rosato character, flowers, and spice.",
    "details": "Silvia Zucchi's Charmat-method Lambrusco di Sorbara Rosato has long been on the list, but Zucchi also makes two Metodo Classico wines from Lambrusco di Sorbara. Although the wines are not generally imported, Polaner was able to secure 15 cases as an exclusive by-the-glass pour, adding another distinctive element to the Rezdora wine program.",
    "pairing": "A strong aperitif and antipasti pairing, especially where dry bubbles, red-fruited lift, floral notes, and spice can brighten the dish."
  },
  {
    "name": "Chartogne-Taillet ‘Sainte-Anne’ Brut Champagne NV",
    "producer": "Chartogne-Taillet",
    "vintage": "Non Vintage",
    "status": "previous",
    "region": "Champagne",
    "subregion": "Merfy, Montagne de Reims",
    "grapes": [
      "Chardonnay",
      "Pinot Noir",
      "Pinot Meunier"
    ...
    "style": "Sparking",
    "body": "Light-medium",
    "image": "images/nvchartogne-taillet.avif",
    "farming": "Practicing organic",
    "price": "$38 (glass), $175 (bottle)",
  ...
  },
  {
    ...
    "style": "Red",
    "body": "Medium-full",
    "image": "images/Malvirariserva.webp",
  ...
  },
  {
    ...
    "style": "White",
    "body": "Medium-full",
    "image": "images/Pramontegrande.webp",
    "farming": "Certified Organic",
  ...
  },
  {
    ...
    "style": "Red",
    "body": "Full",
    "image": "images/Niccoluciromagna.jpeg",
  ...
  },
  {
    ...
    "style": "Red",
    "body": "Full",
    "image": "images/LeVoltedell'Ornellaia.webp",
    "farming": "Conventional",
    "price": "$25 glass / $95 bottle",
  ...
  },
  {
    ...
    "style": "Red",
    "body": "Medium-full",
    "image": "images/BludiBursonLonganesi.jpeg",
    "farming": "N/A",
    "price": "N/A",
  ...
  },
  {
    ...
    "style": "Sparkling red",
    "body": "Medium",
    "image": "images/LambruscoGrasparossa .jpeg",
    "farming": "Organic",
    "price": "N/A",
  ...
  },
  {
    ...
    "menu": "Dinner",
    "course": "Antipasta",
    "menuDescription": "Maitake mushroom, black truffle, parsley",
    "pronunciation": "boo-RRAH-tah reh-AH-leh",
    ...
    "ingredients": [
      "Burrata",
      "Truffle and maitake puree",
      "Roasted maitake",
      "Shaved black truffle",
      "Parsley oil",
      "Micro parsley"
    ],
    "oneLiner": "Our burrata reale, with maitake and truffle puree, roasted maitake mushrooms, and parsley oil.",
    "details": "Burrata is filled with a truffle mushroom puree, plated on a bed of roasted maitake, garnished with micro parsley and parsley oil, and finished on the pass with shaved black truffle. Maitake puree is made with maitake, parsley, shallots, truffle, EVOO, and salt. Roasted maitake is dressed with EVOO, red wine vinegar, chopped parsley, and salt. Parsley oil is made with sunflower oil and parsley."
  },
  {
    "type": "food",
    "name": "Cacio e Pepe in Emilia",
    "status": "current",
    "category": "Antipasta",
    "menu": "Dinner",
    "course": "Antipasta",
    ...
    "oneLiner": "The cacio salad with pecorino and parmigiano dressing and fresh cracked pepper.",
    "details": "Typically a Roman pasta dish, this is Rezdora's take in salad form. Baby gem lettuce is garnished with pecorino, a sheep's milk cheese, a generous amount of black pepper, and pecorino dressing made with pasteurized egg yolks, lemon juice, oil, pecorino, and parmigiano. The cheese is shaved fresh to garnish the salad with fresh black pepper, with aged balsamic vinegar tucked inside. Essentially, it is a play on the typical Roman pasta dish."
  },
  {
    "type": "food",
    "name": "Fett'unta",
    ...
    "ingredients": [
      "Grilled bread from Amy's Bakery",
      "Extra virgin olive oil",
      "Raw garlic",
      "Salt"
    ],
    "oneLiner": "The toasted fett'unta bread with garlic and extra virgin oil.",
    "details": "Fett'unta means greasy slice and is typically served at the beginning of a new olive oil harvest in southern Emilia-Romagna and Tuscany. The dish is made with grilled bread from Amy's Bakery, extra virgin olive oil, raw garlic rubbed onto the bread, and salt."
  },
  {
    "type": "food",
    "name": "Gnocco Fritto",
    ...
    "pronunciation": "NYOH-koh FREE-toh",
    ...
    "oneLiner": "Gnocco fritto with guanciale, mortadella, and prosciutto di Parma.",
    "details": "Fried dough shaped like large pillows and used as the vessel for salumi: prosciutto di Parma, mortadella, and guanciale. This is one of the most traditional and ubiquitous items eaten in Emilia-Romagna."
  },
  {
    "type": "food",
    ...
    "oneLiner": "Fennel, agrodolce nectarines, thyme, and pinenuts.",
    "details": "Fennel is sliced thin. Nectarine slices are marinated in agrodolce vinegar. Nectarines are sauteed with thyme and olive oil, then blended with a bit of agrodolce vinegar and water for the vinaigrette. Pinenuts are mixed with thyme and egg white, then baked for the crumble. On the plate, a few sprigs of micro arugula are added for color. Vinaigrette: EVOO, salt, nectarines, thyme, and agrodolce vinegar. Marinated nectarines: nectarines, agrodolce vinegar, and water. Thyme pinenut crumble: pinenuts, egg white, thyme, and salt."
  },
  {
    "type": "food",
    "name": "Parmigiano Tasting",
    "status": "current",
    "category": "Antipasta",
    "menu": "Dinner",
    "course": "Antipasta",
    ...
    "ingredients": [
      "24 month parmigiano",
      "24 month Vacche Rosse parmigiano",
      "36 month parmigiano",
      "48 month parmigiano",
      "60 month parmigiano",
      "Balsamico",
    ...
    "oneLiner": "From left to right, there is 24 month parmigiano, 24 month Vacche Rosse parmigiano, 36 month parmigiano, 48 month parmigiano, and 60 month parmigiano. The 60 month is served with balsamic vinegar. The board is served with pear mustard and rosemary crackers.",
    "details": "From left to right: 24 month parmigiano, 24 month Vacche Rosse parmigiano, 36 month parmigiano, 48 month parmigiano, and 60 month parmigiano. The 60 month is served with balsamic vinegar."
  },
  {
    "type": "food",
    ...
    "menu": "Dinner",
    "course": "Antipasta",
    "menuDescription": "Onion three ways",
    "pronunciation": "strah-chah-TEHL-lah kohn chee-POHL-lah",
    "mise": "Small Fork, Butter Knife",
    "winePairings": [],
    "allergies": [
      "Allium",
